...
function dialogRegister() {
	...
	if (dialogOptions.descriptionIsHtml) {
		document.querySelector('#label').innerHTML = dialogOptions.description;
	} else {
		document.querySelector('#label').textContent = dialogOptions.description;
	}
	...
	dataContainerElement.innerHTML = dialogOptions.form;
}
